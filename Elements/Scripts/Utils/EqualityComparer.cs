...
namespace Atomic.Elements
{
    ...
    internal static class EqualityComparer
    {
        ...
        // public static readonly IEqualityComparer<float3> float3 = new float3EqualityComparer();
        // public static readonly IEqualityComparer<quaternion> quaternion = new quaternionEqualityComparer();
        ...
        // static readonly RuntimeTypeHandle m_quaternionType = typeof(quaternion).TypeHandle;
        // static readonly RuntimeTypeHandle m_float3Type = typeof(float3).TypeHandle;
        ...
        static object GetDefaultHelper(Type type)
        {
            ...
            // if (t.Equals(m_quaternionType)) return quaternion;
            // if (t.Equals(m_float3Type)) return float3;
            //
        ...
        //     {
        //         return math.all(x.value == y.value);
        //     }
        //
        //     public int GetHashCode(quaternion obj)
        //     {
        //         return (int) math.hash(obj);
        //     }
        // }
        //
        // sealed class float3EqualityComparer : IEqualityComparer<float3>
        // {
