...
namespace Atomic.Objects
{
    internal sealed class TagWindow : EditorWindow
    {
        ...
        {
            this.titleContent = new GUIContent("Atomic Tags");
        }

        private void OnGUI()
        {
            this.catalog = CatalogTools.GetTagCatalog();
        ...
        private void DrawHeader()
        {
            ...
            rect.x += 10;
            GUI.Label(rect, "Atomic Tags:", labelStyle);
        ...
        private void DrawCustomElement(int itemIndex)
        {
            ...
            SerializedProperty id = key.FindPropertyRelative(nameof(TagCatalog.Item.id));
            SerializedProperty type = key.FindPropertyRelative(nameof(TagCatalog.Item.type));
        ...
        private void DrawCompileButton()
        {
            ...
            {
                TagAPIGenerator.Generate(this.catalog);
            }
