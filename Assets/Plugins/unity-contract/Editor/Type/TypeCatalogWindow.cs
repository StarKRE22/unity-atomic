...
namespace Contracts
{
    internal sealed class TypeCatalogWindow : EditorWindow
    {
        ...
        {
            this.titleContent = new GUIContent("Contract Types");
        }

        private void OnGUI()
        {
            this.catalog = EditorTools.GetTypeCatalog();
        ...
        private void DrawHeader()
        {
            ...
            rect.x += 10;
            GUI.Label(rect, "Contract Types:", labelStyle);
        ...
        private void DrawCustomElement(int itemIndex)
        {
            ...
            SerializedProperty id = key.FindPropertyRelative(nameof(TypeCatalog.Item.id));
            SerializedProperty type = key.FindPropertyRelative(nameof(TypeCatalog.Item.type));
        ...
        private void DrawCompileButton()
        {
            ...
            {
                TypeAPIGenerator.Generate(this.catalog);
            }
