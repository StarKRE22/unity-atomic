...
namespace Contracts
{
    public sealed class TypeCatalog : ScriptableObject
    {
        [SerializeField]
        public string @namespace = "Contracts";

        [SerializeField]
        public string directoryPath = "Assets/Plugins/unity-contract/Codegen";
        
        [SerializeField]
        public string className = "TypeAPI";
        ...
        {
            return this.items.Select(it => $"{it.id}. ({it.type})").ToArray();
        }
    }
}
#endif