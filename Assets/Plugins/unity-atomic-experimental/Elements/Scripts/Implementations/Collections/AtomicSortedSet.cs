...
{
    [Serializable]
    public class AtomicSortedSet<T> : IAtomicSet<T>, ISerializationCallbackReceiver
    {
        ...
        public AtomicSortedSet()
        {
            this.set = new SortedSet<T>();
        }

        public AtomicSortedSet(IEnumerable<T> elements, IComparer<T> comparer)
        {
