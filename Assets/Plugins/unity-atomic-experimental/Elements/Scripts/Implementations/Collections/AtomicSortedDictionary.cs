...
{
    [Serializable]
    public class AtomicSortedDictionary<K, V> :  IAtomicDictionary<K, V>, ISerializationCallbackReceiver
    {
        ...
        public AtomicSortedDictionary()
        {
            this.dictionary = new Dictionary<K, V>();
        }

        public AtomicSortedDictionary(int capacity = 0)
        {
