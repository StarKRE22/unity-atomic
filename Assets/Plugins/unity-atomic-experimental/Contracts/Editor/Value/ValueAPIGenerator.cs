...
namespace Atomic.Contracts
{
    ...
    {
        private const string NAMESPACE = "Atomic.Objects";
        private const string OBJECT_CLASS = "IObject";
        ...
        private static void GenerateObjectExtensions(StreamWriter writer, string itemName)
        {
            ...
            writer.WriteLine(
                $"        public static object Get{itemName}(this {OBJECT_CLASS} obj) => obj.GetValue({itemName});");
            writer.WriteLine();

            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static bool TryGet{itemName}(this {OBJECT_CLASS} obj, out object value) => obj.TryGetValue({itemName}, out value);");
            writer.WriteLine();

            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static bool Add{itemName}(this {OBJECT_CLASS} obj, object value) => obj.AddValue({itemName}, value);");
            writer.WriteLine();

            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static bool Del{itemName}(this {OBJECT_CLASS} obj) => obj.DelValue({itemName});");
            writer.WriteLine();

            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static void Set{itemName}(this {OBJECT_CLASS} obj, object value) => obj.SetValue({itemName}, value);");
        }
        ...
        private static void GenerateTypedExtensions(StreamWriter writer, string itemType, string itemName)
        {
            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static {itemType} Get{itemName}(this {OBJECT_CLASS} obj) => obj.GetValue<{itemType}>({itemName});");
            writer.WriteLine();

            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static bool TryGet{itemName}(this {OBJECT_CLASS} obj, out {itemType} value) => obj.TryGetValue({itemName}, out value);");
            writer.WriteLine();
            ...
            //     writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            //     writer.WriteLine(
            //         $"        public static void Add{itemName}(this {OBJECT_CLASS} obj, {itemType} value) => obj.AddElement({itemName}, value);");
            // }
            // else
            // {
            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static bool Add{itemName}(this {OBJECT_CLASS} obj, {itemType} value) => obj.AddValue({itemName}, value);");
            // }
            ...
            writer.WriteLine("        [MethodImpl(MethodImplOptions.AggressiveInlining)]");
            writer.WriteLine(
                $"        public static void Set{itemName}(this {OBJECT_CLASS} obj, {itemType} value) => obj.SetValue({itemName}, value);");
            // }
        }
