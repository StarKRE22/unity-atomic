...
// {
//     [UsedImplicitly]
//     public sealed class ValueKeyAttributeDrawer : OdinAttributeDrawer<ReferenceIdAttribute, string>
//     {
//         protected override void DrawPropertyLayout(GUIContent label)
//         {
//             ReferenceCatalog catalog = EditorTools.GetValueCatalog();
//
//             if (catalog == null)
//             {
...
//         }
//
//         private static void RetrieveIndexes(string input, ReferenceCatalog catalog, out int categoryIndex,
//             out int itemIndex)
//         {
